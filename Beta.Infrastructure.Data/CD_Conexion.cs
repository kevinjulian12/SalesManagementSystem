...
namespace Beta.Infraestructura.Data
{
    public class CD_Conexion
    {
        ...
        public static string LeerINI(string Seccion, string Clave)
        {
            ...
            int i = GetPrivateProfileString(Seccion, Clave, "", temp, 255, @"D:\AzureRemote\Beta.Infrastructure.Data\Conexion.ini\Conexion.ini");
